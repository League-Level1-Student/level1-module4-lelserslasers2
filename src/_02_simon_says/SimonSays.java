...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		JOptionPane.showMessageDialog(null, "Press the match key when 'Simon says' otherwise press a different key");
	...
	public void keyPressed(KeyEvent e) {
		...
		if (tries > 8) {
			  ...
			  speak("Score was " + Integer.toString(score) + ", thanks for playing!");
